...
import com.tasklist.controller.TaskManager;
import com.tasklist.controller.exporting.Exporter;
import com.tasklist.controller.importing.Importer;
import com.tasklist.util.comparator.MemoryUsedDescendingComparator;
import com.tasklist.util.comparator.TaskDtoDiffLeftMemoryDescendingComparator;
import com.tasklist.util.comparator.TaskDtoDiffMaxMemoryDescendingComparator;
import com.tasklist.util.comparator.TaskDtoDiffRightMemoryDescendingComparator;
import com.tasklist.model.DiffSign;
...
public class MainApp extends Application {
    ...
    private void setIcon() {
        String iconPath = "/images/task-manager-icon.png";
        try {
    ...
    private void showTaskList() {
        try {
            FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("/fxml/TaskManager.fxml"));
